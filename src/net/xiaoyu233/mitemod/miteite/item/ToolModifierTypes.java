...
//  自然祝福 - 每一个怪物被杀死都有概率恢复饱食度.有时在杀死一群怪物后,有概率对玩家进行治疗。 (completed)
//  自然之力 - 攻击一个怪物：20%概率燃烧目标.20%概率给予玩家速度效果.20%概率给予玩家力量效果。 (abandoned)
//  启示录 - 你的受害者将会变得奄奄一息,并且会受到越来越多凋零效果的折磨。 (completed)
//  恶魔之力 - 对非主世界的怪物造成额外的伤害。 (completed)
//  百折不挠 - 当你的生命值越低，造成的伤害也就越高。 (completed)
//  海纳百川 - 你的生命值越高，造成的伤害也就越高。 (completed)
//  不动如山 - 格挡时可以减少更多的伤害 (completed)
//  可燃 - 火焰附加 (abandoned)
//  剧毒 - 给予目标中毒效果 (abandoned)
// }
// Tool Modifiers{
//  震击 - 挖掘方块时充能,到达一定层数后提供一段时间的急迫和速度
//  老成 - 挖掘方块时有几率掉落经验 (abandoned)
//  自然祝福 - 每挖掘一个方块都有概率恢复饱食度.有时在挖掘一定数量的方块后,有概率对玩家进行治疗。
//  圣盾 - 当这个工具在你手中时,你将被赋予抗火效果.此外,损害减少,但耐久也会随之减低。
//  不动如山 - 格挡时可以减少更多的伤害 (completed)
//  自动冶炼 - 自动烧制挖掘等级比此属性级数小的目标方块 (completed)
// }
